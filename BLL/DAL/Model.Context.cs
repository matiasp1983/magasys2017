...
public partial class MAGASYSEntities : DbContext
{
    ...
    public virtual ObjectResult<ObtenerDevolucionesPorTipoProducto_V2_Result> ObtenerDevolucionesPorTipoProducto_V2(string codEdicion, Nullable<System.DateTime> fechaDesde)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ObtenerDevolucionesPorTipoProducto_V2_Result>("ObtenerDevolucionesPorTipoProducto_V2", codEdicionParameter, fechaDesdeParameter);
    }
