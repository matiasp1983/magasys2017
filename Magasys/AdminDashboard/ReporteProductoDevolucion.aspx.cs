...
{
    public partial class ReporteProductoDevolucion : System.Web.UI.Page
    {
        #region Eventos
        ...
        [WebMethod]
        public static List<object> ObtenerProductoDevolucion(string pAnio, string pTipoProducto)
        {
            List<ProductosDevueltosXAnio_Result> lstDatos = null;
            ...
            if (!string.IsNullOrEmpty(pAnio))
            {
                var loProductoDevolucion = new ProductoDevolucionBLL();

                if (string.IsNullOrEmpty(pTipoProducto))
                {
                    lstDatos = loProductoDevolucion.ProductosDevueltosPorAnio(pAnio);
                }
                else
                {
                    lstDatos = loProductoDevolucion.ProductosDevueltosPorAnio(pAnio, pTipoProducto);
                }
