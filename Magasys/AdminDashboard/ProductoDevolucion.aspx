...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>Devolución de Productos a Proveedores</h2>
            <ol class="breadcrumb">
                <li>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <form id="FormDevolucion" runat="server">
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <asp:ListView ID="lsvDevolucion" runat="server" Visible="false" OnItemDataBound="LsvDevolucion_ItemDataBound">
                                <LayoutTemplate>
                                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15" data-filter=#filter>
                                        <thead>
                                            <tr>                                                    
                                                <th data-hide="phone,tablet" class="text-left">Producto</th>
                                                <th data-toggle="true" class="text-left">Edición</th>
                                                <th data-hide="phone,tablet">Tipo de Producto</th>
                                                <th data-hide="phone,tablet">Código Producto</th>
                                                <th data-hide="phone,tablet">Fecha Edición</th>
                                                <th data-hide="phone,tablet">Fecha Devolución</th>
                                                <th>Stock</th>
                                                <th>Reservas</th> <%--Son las reservas Confirmadas--%>
                                                <th>Cantidad</th>
