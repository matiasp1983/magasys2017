...
namespace PL.AdminDashboard
{
    public partial class ProductoPeliculaEditar : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session[Enums.Session.ProductoPelicula.ToString()] != null)
                {
                    ...
                    if (oProductoPelicula.IMAGEN != null)
                    {
                        ...
                        imgPreview.ImageUrl = loImagenDataURL64;
                        txtTitulo.Text = oProductoPelicula.IMAGEN.NOMBRE;
                    }
                }
                else
                    Response.Redirect("ProductoListado.aspx", false);
        ...
        private BLL.DAL.Producto CargarProductoDesdeControles()
        {
            ...
            else if (imgPreview.ImageUrl != "~/AdminDashboard/img/preview_icons.png" && ((BLL.ProductoPelicula)Session[Enums.Session.ProductoPelicula.ToString()]).IMAGEN != null) // Mantenemos la imagen
                oProducto.COD_IMAGEN = ((BLL.ProductoPelicula)Session[Enums.Session.ProductoPelicula.ToString()]).IMAGEN.ID_IMAGEN;
