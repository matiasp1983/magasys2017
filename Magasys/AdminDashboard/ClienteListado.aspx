<%@ Page Title="Listado de Clientes" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="ClienteListado.aspx.cs" Inherits="PL.AdminDashboard.ClienteListado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <form id="FormClienteListado" runat="server">
            <div class="row">
                <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <br />
                            <asp:ListView ID="lsvClientes" runat="server" OnItemDataBound="LsvClientes_ItemDataBound">
                                <LayoutTemplate>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td class="text-left">
                                            <asp:Label ID="lblCodigo" runat="server" Text='<%#Eval("ID_CLIENTE")%>'></asp:Label>
                                        </td>
                                        <td class="text-left">
