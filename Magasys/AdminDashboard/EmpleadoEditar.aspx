<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="EmpleadoEditar.aspx.cs" Inherits="PL.AdminDashboard.EmpleadoEditar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/style.googlemap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    <form id="FormEmpleadoEditar" runat="server" class="form-horizontal">
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>
                            <asp:Label ID="lblBreadcrumbActive" runat="server" Text="Editar Empleado"></asp:Label>
                        </strong>
                    </li>
                </ol>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b" id="divEmail">
                                        ...
                                        <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" MaxLength="50" autocomplete="off" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b" id="divTelefonoMovil">
                                        ...
                                        <asp:TextBox ID="txtTelefonoMovil" runat="server" CssClass="form-control" MaxLength="11" autocomplete="off" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group m-b" id="divTelefonoFijo">
                                        ...
                                        <asp:TextBox ID="txtTelefonoFijo" runat="server" CssClass="form-control" MaxLength="11" autocomplete="off" Text=""></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    ...
    <script type="text/javascript">
        ...
        var FormEmpleado = '#<%=FormEmpleadoEditar.ClientID%>';
        var autocomplete;
