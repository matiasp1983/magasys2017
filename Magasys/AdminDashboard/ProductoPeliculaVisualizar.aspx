<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductoPeliculaVisualizar.aspx.cs" Inherits="PL.AdminDashboard.ProductoPeliculaVisualizar" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    <form id="FormProductoPeliculaVisualizar" runat="server" class="form-horizontal">
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>
                            <asp:Label ID="lblBreadcrumbActive" runat="server" Text="Visualizar Producto Película"></asp:Label>
                        </strong>
                    </li>
                </ol>
            </div>
                ...
                <div class="ibox-content">
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div id="divPelicula" runat="server" class="panel-body" visible="true">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div id="divAnioDeEstrenoPelicula">
                                                    <asp:TextBox ID="txtAnioDeEstrenoPelicula" runat="server" CssClass="form-control" disabled="" autocomplete="off"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <div class="input-group m-b" id="divPrecioPelicula">
                                                    ...
                                                    <asp:TextBox ID="txtPrecioPelicula" runat="server" CssClass="form-control" disabled="" autocomplete="off"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
