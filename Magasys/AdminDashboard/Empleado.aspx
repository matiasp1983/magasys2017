<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="Empleado.aspx.cs" Inherits="PL.AdminDashboard.Empleado" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/style.googlemap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    <form id="FormEmpleado" runat="server" class="form-horizontal">
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">
                        <strong>
                            <asp:Label ID="lblBreadcrumbActive" runat="server" Text="Alta de Empleado"></asp:Label>
                        </strong>
                    </li>
                </ol>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    ...
    <script type="text/javascript">
        ...
        var FormEmpleado = '#<%=FormEmpleado.ClientID%>';
        var autocomplete;
