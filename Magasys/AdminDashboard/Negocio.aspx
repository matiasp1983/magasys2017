<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="Negocio.aspx.cs" Inherits="PL.AdminDashboard.Negocio" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/style.googlemap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">
    <form id="FormNegocio" runat="server" class="form-horizontal">
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <asp:Label ID="lblDireccion" runat="server" MaxLength="150" autocomplete="off"></asp:Label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ibox-content">                  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-md-4" style="text-align: right">
                            ...
                            <asp:Button ID="btnCancelar" runat="server" Text="Cancelar" CssClass="btn btn-primary" OnClick="BtnCancelar_Click" formnovalidate="formnovalidate" />
                        </div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="script" runat="server">
    ...
    <script type="text/javascript">
        ...
        var FormNegocio = '#<%=FormNegocio.ClientID%>';
        var autocomplete;
