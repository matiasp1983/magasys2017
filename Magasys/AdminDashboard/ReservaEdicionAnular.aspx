<%@ Page Title="" Language="C#" MasterPageFile="~/AdminDashboard/MasterPage.Master" AutoEventWireup="true" CodeBehind="ReservaEdicionAnular.aspx.cs" Inherits="PL.AdminDashboard.ReservaEdicionAnular" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">    
    <link href="css/plugins/iCheck/custom.css" rel="stylesheet">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentMaster" runat="server">  
    <form id="FormReservaEdicionAnular" runat="server"> 
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                <h2>Anular Reservas de ediciones</h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <li class="active">
                        <strong>Anular Reservas de ediciones</strong>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Buscar Reserva de ediciones</h5>
                            </div>
                            ...
                            <asp:ListView ID="lsvReservas" runat="server" Visible="true">
                                    ...
                                    <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                        <thead>
                                            <tr>                                                    
                                                ...
                                                <th data-hide="phone,tablet">Cód. reserva edición</th>                                                
                                            </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-left">
                                            <asp:Label ID="lblIdReserva" runat="server" Text='<%#Eval("EDICION").ToString()%>'></asp:Label>
                                        </td>
                                        <td class="text-left">
                                        ...
                                        <td>
                                            <asp:Label ID="lblCodReservaEdicion" runat="server" Text='<%#Eval("ID_RESERVA_EDICION").ToString()%>'></asp:Label>
                                        </td>
                                        <td>
